...
test_that("restarting a job works (.org)", {
  ...
  expect_is(
    travis_restart_job(
      travis_get_jobs(
        travis_get_builds(repo = repo, endpoint = ".org")[[3]]$id,
        endpoint = ".org"
      )[[1]]$id,
      endpoint = ".org"
    ),
...
test_that("restarting a job works (.com)", {
  expect_is(
    travis_restart_job(
      travis_get_jobs(
        travis_get_builds(repo = repo, endpoint = ".com")[[3]]$id,
        endpoint = ".com"
      )[[1]]$id,
      endpoint = ".com"
    ),
...
test_that("retrieving logs works (.org)", {
  expect_is(
    travis_get_log(
      travis_get_jobs(
        travis_get_builds(repo = repo, endpoint = ".org")[[4]]$id,
        endpoint = ".org"
      )[[1]]$id,
      endpoint = ".org"
    ),
...
test_that("retrieving logs works (.com)", {
  expect_is(
    travis_get_log(
      travis_get_jobs(
        travis_get_builds(repo = repo, endpoint = ".com")[[4]]$id,
        endpoint = ".com"
      )[[1]]$id,
      endpoint = ".com"
    ),
